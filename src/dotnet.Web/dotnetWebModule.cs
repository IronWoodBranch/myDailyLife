...
namespace dotnet.Web
{
    [RelyOn(
        ...
        typeof(dotnetHttpClientModule),
        typeof(dotnetAbilityModule)
    )]
    public class dotnetWebModule : AceModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                c.SwaggerDoc("dotnet", new OpenApiInfo { Title = "dotnet.Web", Version = "v1" });
            ...
            {
                opt.Create<dotnetAbilityModule>();
            });
        }
        public override void OnApplicationInitialization(ApplicationInitializationContext context)
        {
            ...
            {
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/dotnet/swagger.json", "dotnet.Web v1"));
            }
